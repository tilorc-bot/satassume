...
``python -m satrefine.tools.refine_specialize --write`` and never edited by hand.
...
assignments, where ``handlers_dict`` is
:data:`satrefine.identities.core.driver.generated_handlers`).
