#!/usr/bin/env python
"""Moved to ``satrefine/tools/refine_ablate.py``: run ``python -m satrefine.tools.refine_ablate``.
...
runpy.run_path(os.path.join(sys.path[0], "satrefine", "tools", "refine_ablate.py"), run_name="__main__")
